...
public class CSVReader {
    ...
    public LocalTime getTime(int columnIndex, String format) throws Exception {
        if (this.get(columnIndex).equals("")) {
            throw new Exception("Empty value!");
        }
    ...
    public LocalDate getDate(int columnIndex, String format) throws Exception {
        if (this.get(columnIndex).equals("")) {
            throw new Exception("Empty value!");
        }
    ...
    public LocalTime getTime(String columnName, String format) throws Exception {
        return this.getTime(this.columnLabelsToInt.get(columnName), format);
    }

    public LocalDate getDate(String columnName, String format) throws Exception {
